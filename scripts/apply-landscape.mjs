...
for (const spec of landscape.integrations) {
  ...
  emitted[spec.constant ?? spec.name] = integration.id
}
...
if (emit) {
  const lines = [
    '// Generated by scripts/apply-landscape.mjs. Do not edit by hand.',
    '//',
    '// Ids rather than names, because an integration can be renamed in the UI',
    '// without the code that reports against it having to change.',
    '',
